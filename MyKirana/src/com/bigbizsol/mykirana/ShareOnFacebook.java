...
public class ShareOnFacebook{
	private static final String APP_ID = "291389657689783";
...
//				new LoginDialogListener(mContext) );
	...
	private class PsotWallAsync extends AsyncTask<Void, Void, Void>
	{
		...
		protected void onPreExecute() {
			...
			progressDialog = ProgressDialog.show(activity,"Dialog","Loading...",true);
			Intent i=new Intent(c, HomeScreen.class);
